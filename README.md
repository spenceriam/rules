...
- **Page:** https://spenceriam.github.io/rules/
- **Raw markdown (for agents):** https://raw.githubusercontent.com/spenceriam/rules/main/index.md
...
```
Read https://spenceriam.github.io/rules/ and adopt both critical instructions as your operating contract for this session.
```
